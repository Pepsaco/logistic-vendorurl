...
import AddDeliveryDetails from "@/components//AddDeliveryDetails.vue";
...
const handleDeliverySubmited = (delivery) =>{
    ...
    if (getFromSession(pickupKey) !== null) {
      let storedPickup = getFromSession(pickupKey);
        // let storedPickup = JSON.parse(localStorage.getItem(pickupKey));
