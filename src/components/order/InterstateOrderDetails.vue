    ...
    <div class="bg-white">
        ...
        <div class="header sticky top-0 left-0 right-0 bg-white pl-[17px] pr-[18px] pt-3 pb-[13px] justify-center items-center flex" style="box-shadow: 0px 4px 4px 0px #00000040;">
            <div class="w-[15%] flex justify-start"> 
                 <RouterLink :to="`/vendor/${slug}/send/item`" ><img src="../../assets/images/icons/arrow_back.png" alt=""></RouterLink>
        ...
        <div class="relative top-0 left-0 right-0 mx-auto px-3 mt-6">
            ...
            <Accordion title="Order and Item Details" :defaultOpen="true">
                ...
                <div class="flex  mt-2  px-2">
                    ...
                    <div class="w-[50%] flex items-center  justify-end">
                        ...
                        <span  class="font-poppins text-[12px] font-light ">{{packagetype}}</span>
                    </div>
                </div>
            ...
            <Accordion title="Delivery and Pickup">
                <div class="grid border-b pt-[7px] pl-[12px] pb-[18px] pr-[12px] border-[#F3F3F3]">
                    <div class="my-[10px] flex bg-white w-full">
                        ...
                        <span class="w-[85%] text-[#383838] text-[12px] font-poppins font-light capitalize">{{pAddress}},{{ pLocation }}</span> 
                    </div>
                    <div class="flex w-full">
                        <div class="w-[70%] grid items-center">
                            <span class="font-poppins text-[14px] font-medium leading-[130%] capitalize">{{pName}}</span>
                        </div>
                ...
                <div class="grid border-b pt-[7px] pl-[12px] pb-[18px] pr-[12px] border-[#F3F3F3]">
                    <div class="my-[10px] flex bg-white w-full">
                        ...
                        <span class="w-[85%] capitalize text-[#383838] text-[12px] font-poppins font-light">{{ dAddress}},{{ dLocation }}</span> 
                    </div>
                    <div class="flex w-full">
                        <div class="w-[70%] grid items-center">
                            <span class="capitalize font-poppins text-[14px] font-medium leading-[130%]">{{ dName}}</span>
                        </div>
                        <div class="w-[30%] flex items-center justify-end">
                            <a v-if="orderstatus == 'paired' || orderstatus == 'pickedup'  || orderstatus == 'enroute'" :href="`tel:${dPhone}`" class="pr-3 w-[50%]">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M21.97 18.33C21.97 18.69 21.89 19.06 21.72 19.42C21.55 19.78 21.33 20.12 21.04 20.44C20.55 20.98 20.01 21.37 19.4 21.62C18.8 21.87 18.15 22 17.45 22C16.43 22 15.34 21.76 14.19 21.27C13.04 20.78 11.89 20.12 10.75 19.29C9.6 18.45 8.51 17.52 7.47 16.49C6.44 15.45 5.51 14.36 4.68 13.22C3.86 12.08 3.2 10.94 2.72 9.81C2.24 8.67 2 7.58 2 6.54C2 5.86 2.12 5.21 2.36 4.61C2.6 4 2.98 3.44 3.51 2.94C4.15 2.31 4.85 2 5.59 2C5.87 2 6.15 2.06 6.4 2.18C6.66 2.3 6.89 2.48 7.07 2.74L9.39 6.01C9.57 6.26 9.7 6.49 9.79 6.71C9.88 6.92 9.93 7.13 9.93 7.32C9.93 7.56 9.86 7.8 9.72 8.03C9.59 8.26 9.4 8.5 9.16 8.74L8.4 9.53C8.29 9.64 8.24 9.77 8.24 9.93C8.24 10.01 8.25 10.08 8.27 10.16C8.3 10.24 8.33 10.3 8.35 10.36C8.53 10.69 8.84 11.12 9.28 11.64C9.73 12.16 10.21 12.69 10.73 13.22C11.27 13.75 11.79 14.24 12.32 14.69C12.84 15.13 13.27 15.43 13.61 15.61C13.66 15.63 13.72 15.66 13.79 15.69C13.87 15.72 13.95 15.73 14.04 15.73C14.21 15.73 14.34 15.67 14.45 15.56L15.21 14.81C15.46 14.56 15.7 14.37 15.93 14.25C16.16 14.11 16.39 14.04 16.64 14.04C16.83 14.04 17.03 14.08 17.25 14.17C17.47 14.26 17.7 14.39 17.95 14.56L21.26 16.91C21.52 17.09 21.7 17.3 21.81 17.55C21.91 17.8 21.97 18.05 21.97 18.33Z" fill="#191D31"/>
                                </svg>
                            </a>
                            <button v-if="orderstatus == 'enroute'" type="button" class="pr-3" @click="GenerateReceiverCode()">
                                <svg width="24" height="24" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11.6023 5.8725C11.1613 4.73162 10.3956 3.74498 9.39989 3.03453C8.4042 2.32408 7.22215 1.92096 5.99984 1.875C4.77753 1.92096 3.59549 2.32408 2.59979 3.03453C1.6041 3.74498 0.838401 4.73162 0.39734 5.8725C0.367553 5.95489 0.367553 6.04511 0.39734 6.1275C0.838401 7.26838 1.6041 8.25502 2.59979 8.96547C3.59549 9.67592 4.77753 10.079 5.99984 10.125C7.22215 10.079 8.4042 9.67592 9.39989 8.96547C10.3956 8.25502 11.1613 7.26838 11.6023 6.1275C11.6321 6.04511 11.6321 5.95489 11.6023 5.8725ZM5.99984 9.375C4.01234 9.375 1.91234 7.90125 1.15109 6C1.91234 4.09875 4.01234 2.625 5.99984 2.625C7.98734 2.625 10.0873 4.09875 10.8486 6C10.0873 7.90125 7.98734 9.375 5.99984 9.375Z" fill="black"/>
                                    <path d="M6 3.75C5.55499 3.75 5.11998 3.88196 4.74997 4.12919C4.37996 4.37643 4.09157 4.72783 3.92127 5.13896C3.75097 5.5501 3.70642 6.0025 3.79323 6.43895C3.88005 6.87541 4.09434 7.27632 4.40901 7.59099C4.72368 7.90566 5.12459 8.11995 5.56105 8.20677C5.99751 8.29358 6.4499 8.24903 6.86104 8.07873C7.27217 7.90843 7.62357 7.62004 7.87081 7.25003C8.11804 6.88002 8.25 6.44501 8.25 6C8.25 5.40326 8.01295 4.83097 7.59099 4.40901C7.16903 3.98705 6.59674 3.75 6 3.75ZM6 7.5C5.70333 7.5 5.41332 7.41203 5.16665 7.2472C4.91997 7.08238 4.72771 6.84811 4.61418 6.57403C4.50065 6.29994 4.47095 5.99834 4.52882 5.70736C4.5867 5.41639 4.72956 5.14912 4.93934 4.93934C5.14912 4.72956 5.41639 4.5867 5.70737 4.52882C5.99834 4.47094 6.29994 4.50065 6.57403 4.61418C6.84812 4.72771 7.08238 4.91997 7.24721 5.16664C7.41203 5.41332 7.5 5.70333 7.5 6C7.5 6.39782 7.34197 6.77936 7.06066 7.06066C6.77936 7.34196 6.39783 7.5 6 7.5Z" fill="black"/>
                                </svg>
                            </button>
                            <button v-if="orderstatus == 'enroute'"  type="button" class="" @click="ShareReceiverCode()">
                                <svg width="24" height="24" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11 6L7.5 2.5V4.5C4 5 2.5 7.5 2 10C3.25 8.25 5 7.45 7.5 7.45V9.5L11 6Z" fill="black"/>
                                </svg>
                            </button>
                    ...
                    <ReceiverDeliveryCode @CloseReceiver="handlecloseReceiver" v-if="IsConfirmReceiver" :orderno="orderNo" />
                </div>
            </Accordion>
            <Accordion title="Order Report">
                ...
                <div class="bg-[#FFEBEB] rounded py-4 px-2 grid" v-if="orderstatus == 'quotation'">
                    <div class="mb-3 flex w-full ">
                        <span class="w-[60%] font-poppins text-[#000000] text-[14px]" >Quote Ready</span>
                        <span class="w-[40%] text-[#111111] text-[10px]">{{ $format_date(updated_at) }}</span>
                    </div>
                    <div class="text-[#111111] font-poppins text-[12px] grid">
                        <div class="flex w-full">
                            <span class="w-[50%] text-start">Cost of Pickup & Courier </span>
                            <span class="w-[50%] text-end">{{ $formatPrice(pickup_courier) }}</span>
                        </div>
                        <div class="flex w-full">
                            <span class="w-[50%] text-start">Cost of Doorstep Delivery  </span>
                            <span class="w-[50%] text-end">{{ $formatPrice(doorstep_delivery) }}</span>
                        </div>
                        <div class="flex w-full">
                            <span class="w-[50%] text-start">Cost of Insurance  </span>
                            <span class="w-[50%] text-end">{{ $formatPrice(insurance) }}</span>
                        </div>
                        <div class="flex w-full">
                            <span class="w-[50%] text-start">Transaction Fee </span>
                            <span class="w-[50%] text-end">{{ $formatPrice(transaction_fee) }}</span>
                        </div>
                        <div class="flex w-full">
                            <span class="w-[50%] text-start">Total Amount </span>
                            <span class="w-[50%] text-end">{{ $formatPrice(total_amount) }}</span>
                        </div>
                        <div class="grid w-full justify-center">
                            <!-- {{ $formatPrice(total_amount) }} -->
                            <button type="button"  @click="makepayment(total_amount)" class="font-poppins text-[12px] w-[150px] p-3 bg-wine text-white rounded":disabled="processing"> {{ processing ? "Please wait" : `Pay ${$formatPrice(total_amount)}`}} </button>
                            <a href="" class="text-center font-poppins">Cancel Order</a>
                        </div>
                    </div>
                </div>
                <div class="bg-[#FFEBEB] rounded py-4 px-2 grid" v-if="orderstatus == 'paid'">
                    <div class="mb-3 flex w-full ">
                        <span class="w-[60%] font-poppins text-[#000000] text-[14px]" >Payment Done</span>
                        <span class="w-[40%] text-[#111111] text-[10px]">{{ $format_date(updated_at) }}</span>
                    </div>
                    <div class="text-[#111111] font-poppins text-[12px]">
                        📦 {{activity}}
                ...
                <div class="bg-[#FFEBEB] rounded py-4 px-2 grid" v-if="orderstatus === 'pickup'">
                    <div class="mb-3 flex w-full ">
                        <span class="w-[60%] font-poppins text-[#000000] text-[14px]" >Pickup Personnel</span>
                        <span class="w-[40%] text-[#111111] text-[10px]">{{ $format_date(updated_at) }}</span>
                    </div>
                    <div class="grid border-b pt-[7px] pl-[21px] pb-[18px] pr-[21px] border-[#F3F3F3]">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="w-[20%] flex items-center pr-2" v-if="orderstatus != 'delivered'">
                                <!-- <div class=""> -->
                ...
                <div class="bg-[#FFEBEB] rounded py-4 px-2 grid" v-if="orderstatus === 'enroute'">
                    <div class="mb-3 flex w-full ">
                        <span class="w-[60%] font-poppins text-[#000000] text-[14px]" >Driver Detail for Pickup</span>
                        <span class="w-[40%] text-[#111111] text-[10px]">{{ $format_date(updated_at) }}</span>
                    </div>
                    <div class="grid border-b pt-[7px] pl-[21px] pb-[18px] pr-[21px] border-[#F3F3F3]">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="w-[80%] grid items-center pl-2">
                                <span class="font-poppins text-[14px] font-medium leading-[130%]">{{driverName}}</span>
                            </div>
                            <div class="w-[20%] flex items-center pr-2" v-if="orderstatus != 'delivered'">
                                <!-- <div class=""> -->
                                    <span class="w-[50%]">
                                        <a :href="`tel:${driverPhone}`" class="">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M21.97 18.33C21.97 18.69 21.89 19.06 21.72 19.42C21.55 19.78 21.33 20.12 21.04 20.44C20.55 20.98 20.01 21.37 19.4 21.62C18.8 21.87 18.15 22 17.45 22C16.43 22 15.34 21.76 14.19 21.27C13.04 20.78 11.89 20.12 10.75 19.29C9.6 18.45 8.51 17.52 7.47 16.49C6.44 15.45 5.51 14.36 4.68 13.22C3.86 12.08 3.2 10.94 2.72 9.81C2.24 8.67 2 7.58 2 6.54C2 5.86 2.12 5.21 2.36 4.61C2.6 4 2.98 3.44 3.51 2.94C4.15 2.31 4.85 2 5.59 2C5.87 2 6.15 2.06 6.4 2.18C6.66 2.3 6.89 2.48 7.07 2.74L9.39 6.01C9.57 6.26 9.7 6.49 9.79 6.71C9.88 6.92 9.93 7.13 9.93 7.32C9.93 7.56 9.86 7.8 9.72 8.03C9.59 8.26 9.4 8.5 9.16 8.74L8.4 9.53C8.29 9.64 8.24 9.77 8.24 9.93C8.24 10.01 8.25 10.08 8.27 10.16C8.3 10.24 8.33 10.3 8.35 10.36C8.53 10.69 8.84 11.12 9.28 11.64C9.73 12.16 10.21 12.69 10.73 13.22C11.27 13.75 11.79 14.24 12.32 14.69C12.84 15.13 13.27 15.43 13.61 15.61C13.66 15.63 13.72 15.66 13.79 15.69C13.87 15.72 13.95 15.73 14.04 15.73C14.21 15.73 14.34 15.67 14.45 15.56L15.21 14.81C15.46 14.56 15.7 14.37 15.93 14.25C16.16 14.11 16.39 14.04 16.64 14.04C16.83 14.04 17.03 14.08 17.25 14.17C17.47 14.26 17.7 14.39 17.95 14.56L21.26 16.91C21.52 17.09 21.7 17.3 21.81 17.55C21.91 17.8 21.97 18.05 21.97 18.33Z" fill="#191D31"/>
                                            </svg>
                                        </a>
                ...
                <div class="bg-[#FFEBEB] rounded py-4 px-2 grid" v-if="orderstatus === 'transit'">
                    <div class="mb-3 flex w-full ">
                        <span class="w-[60%] font-poppins text-[#000000] text-[14px]" >Package on Transit</span>
                        <span class="w-[40%] text-[#111111] text-[10px]">{{ $format_date(updated_at) }}</span>
                    </div>
                    <div class="text-[#111111] font-poppins text-[12px]">
                        {{activity}}
...
const created_at = ref("");const updated_at = ref("");const activity = ref(""); const orderNo = ref(""); const distance = ref(""); const time = ref(""); const itemCategory = ref(""); const packagetype = ref(""); const priderlink = ref(""); const driderlink = ref(""); const pAddress = ref(""); const pLocation = ref(""); const pName = ref(""); const pPhone = ref(""); const dAddress = ref(""); const dLocation = ref(""); const dName = ref(""); const dPhone = ref(""); const orderstatus = ref(""); 

const rider = ref(""); const riderName = ref(""); const riderPhone = ref(""); const ridervehModel = ref(""); const ridervehPlateno = ref("");const riderphoto = ref(""); const custToken = ref(""); const riderLatitude = ref(""); const riderLongitude = ref("");

const vendorname = ref(""); const vendorphone = ref("");const vendorlogo = ref("");

const pickup_courier= ref(""); const doorstep_delivery= ref(""); const insurance = ref(""); const transaction_fee= ref(""); const total_amount = ref("");

const driverName = ref(""); const driverPhone = ref("");  

const getTrackDetails = async () => {
    try {
        loading.value = true
        const res = await axiosinstance.post('/vendor/dispatch/interstate/order/trace',{
        ...
        pickup_courier.value = res.data.lists.quote.pickup_courier
        doorstep_delivery.value = res.data.lists.quote.doorstep_delivery
        insurance.value = res.data.lists.quote.insurance
        transaction_fee.value = res.data.lists.quote.transaction_fee
        total_amount.value = res.data.lists.quote.total_amount
        ...
        //handling
        //type
        packagetype.value = res.data.lists.order.type
        ...
        riderName.value = res.data.lists.dispatcher.ridername
        riderPhone.value = res.data.lists.dispatcher.riderphone
       // riderAccount.value = res.data.lists.rider.rideraccount
        riderphoto.value = res.data.lists.dispatcher.photo
        ridervehModel.value = res.data.lists.dispatcher.vehiclemodel
        ridervehPlateno.value = res.data.lists.dispatcher.vehicleplateno
        // loading.value = false
        
        driverName.value = res.data.lists.enroutes.handlername
        driverPhone.value = res.data.lists.enroutes.handlerphone
...
const getRandomNumber = (digit) =>{
 ...
 const makepayment = async (total_amount) => {
    ...
    //  const username = ref(authStore.user.data.name.split(" "));
       ...
       finalizeCheckoutPayment(total_amount);
 ...
 const finalizeCheckoutPayment = async (amount) =>{
    try {
        const res = await axiosinstance.post('/dispatch/order/i/confirm/payment',{
